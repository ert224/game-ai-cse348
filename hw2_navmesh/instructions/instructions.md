# Path networks using NavMesh (Navigation Mesh)
...
![An example path network](pathnet.png)
...
![An example navigation mesh](navmesh1.png)
...
![An example navigation mesh](navmesh2.png)
